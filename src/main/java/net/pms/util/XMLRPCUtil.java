...
public class XMLRPCUtil { //TODO: (Nad) Fix XXE here and any other places in this PR
	 ...
	 */
	@Nullable
	public static Params readMethodResponse(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
		Params result = null;
	 ...
	 */
	@Nullable
	public static Value<?> readParam(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	 ...
	 */
	@Nonnull
	public static String readName(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	 ...
	 */
	@Nonnull
	public static String readCharacters(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	 ...
	 * @throws XMLStreamException If an error occurs during the operation.
	 */
	public static void writeMethodEnd(@Nonnull XMLStreamWriter writer) throws XMLStreamException {
	 ...
	 * @throws XMLStreamException If an error occurs during the operation.
	 */
	public static void writeEndElements(@Nonnull XMLStreamWriter writer, int n) throws XMLStreamException {
		if (n < 1) {
	 ...
	 * @throws XMLStreamException If an error occurs during the operation.
	 */
	public static void writeBooleanValue(@Nonnull XMLStreamWriter writer, Boolean value) throws XMLStreamException {
	 ...
	 * @throws XMLStreamException If an error occurs during the operation.
	 */
	public static void writeTextElement(
		@Nonnull XMLStreamWriter writer,
	...
	public static class Params extends ArrayList<Value<?>> {
		 ...
		 *             {@code null}.
		 */
		public Params(@Nonnull Collection<? extends Value<?>> collection) {
			super(collection);
		}
		 ...
		 */
		@Nonnull
		public static Params read(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	...
	public static class Member<E extends Value<T>, T> {
		 ...
		 */
		protected Member(@Nonnull XMLRPCTypes type, @Nonnull String name, @Nonnull E value) {
			if (type == null) {
		 ...
		 */
		@Nullable
		public static Member<? extends Value<?>, ?> read(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
					...
					case XMLStreamReader.START_ELEMENT:
						...
						switch (elementName) {
							...
							case "value":
								...
								if (value == null) {
									throw new XMLRPCException("XML-RPC: Invalid <member> element; <value> is missing");
								}
		 ...
		 */
		@Nullable
		public static String getString(@Nullable Map<String, ? extends Member<?, ?>> members, String memberName) {
			if (members == null) {
				return null;
			}
			Member<?, ?> member = members.get(memberName);
			return member == null || member.getValue() == null ? null : member.getValue().toString();
		}
		 ...
		 */
		public static int getInt(@Nullable Map<String, ? extends Member<?, ?>> members, String memberName) {
			if (members == null) {
				return -1;
			}
			Member<?, ?> member = members.get(memberName);
		...
		/**
		 * Extracts the {@code long} value from the {@link Member} with the
		 * specified name from the specified {@link Map} where the keys are
		 * {@link Member} names and the values are {@link Member}s.
		 * {@link Struct} is an example of such a {@link Map}.
		 * <p>
		 * If a {@link Member} with the specified name doesn't exist or the
		 * {@link Member}'s value can't be parsed to a {@code long}, {@code -1}
		 * is returned.
		 *
		 * @param members the {@link Map} of {@link Member} name and
		 *            {@link Member} pairs.
		 * @param memberName the name of the {@link Member} whose long
		 *            representation to get.
		 * @return The resulting {@code long} or {@code -1} if the value can't
		 *         be parsed to a {@code long} or the {@link Member} doesn't
		 *         exist in the specified {@link Map}.
		 */
		public static long getLong(@Nullable Map<String, ? extends Member<?, ?>> members, String memberName) {
			if (members == null) {
				return -1L;
			}
			Member<?, ?> member = members.get(memberName);
			...
			if (member.getValue() instanceof Number) {
				return ((Number) member.getValue()).longValue();
			}
			try {
				return Long.parseLong(member.getValue().toString());
			} catch (NumberFormatException e) {
				return -1L;
			}
		}
		 ...
		 */
		public static double getDouble(@Nullable Map<String, ? extends Member<?, ?>> members, String memberName) {
			if (members == null) {
				return Double.NaN;
			}
			Member<?, ?> member = members.get(memberName);
		...
		/**
		 * Extracts the {@link Boolean} value from the {@link Member} with the
		 * specified name from the specified {@link Map} where the keys are
		 * {@link Member} names and the values are {@link Member}s.
		 * {@link Struct} is an example of such a {@link Map}.
		 * <p>
		 * If a {@link Member} with the specified name doesn't exist or the
		 * {@link Member}'s value can't be parsed to a {@link Boolean},
		 * {@code null} is returned.
		 * <p>
		 * <b>Note:</b> This method returns {@code null} if the parsing fails.
		 * To always get a {@code boolean} result, use
		 * {@link #getBooleanValue(Map, String)} instead.
		 *
		 * @param members the {@link Map} of {@link Member} name and
		 *            {@link Member} pairs.
		 * @param memberName the name of the {@link Member} whose
		 *            {@link Boolean} representation to get.
		 * @return The resulting {@link Boolean} or {@code null} if the value
		 *         can't be parsed or the {@link Member} doesn't exist in the
		 *         specified {@link Map}.
		 *
		 * @see #getBooleanValue(Map, String)
		 */
		@Nullable
		public static Boolean getBoolean(@Nullable Map<String, ? extends Member<?, ?>> members, String memberName) {
			if (members == null) {
				return null;
			}
			Member<?, ?> member = members.get(memberName);
			...
			return ConversionUtil.parseBoolean(member.getValue());
		}
		 ...
		 */
		public static boolean getBooleanValue(@Nullable Map<String, ? extends Member<?, ?>> members, String memberName) {
			if (members == null) {
				return false;
			}
			Member<?, ?> member = members.get(memberName);
			...
			return ConversionUtil.parseBoolean(member.getValue(), true);
		}
	}
	...
	public static class MemberArray extends Member<Value<Array>, Array> {
		 ...
		 */
		public MemberArray(@Nonnull String name, @Nonnull Value<Array> value) {
		 ...
		 */
		public MemberArray(@Nonnull String name, @Nullable Array value) {
	...
	public static class MemberBase64 extends Member<Value<Base64>, Base64> {
		 ...
		 */
		public MemberBase64(@Nonnull String name, @Nonnull Value<Base64> value) {
		 ...
		 */
		public MemberBase64(@Nonnull String name, @Nullable Base64 value) {
	...
	public static class MemberBoolean extends Member<Value<Boolean>, Boolean> {
		 ...
		 */
		public MemberBoolean(@Nonnull String name, @Nonnull Value<Boolean> value) {
		 ...
		 */
		public MemberBoolean(@Nonnull String name, @Nullable Boolean value) {
		 ...
		 */
		public MemberBoolean(@Nonnull String name, boolean value) {
			super(XMLRPCTypes.BOOLEAN, name, new ValueBoolean(value));
		}
		 ...
		 *            using {@link StringUtil#parseBoolean(Object)}.
		 */
		public MemberBoolean(@Nonnull String name, @Nullable Object value) {
			super(XMLRPCTypes.BOOLEAN, name, new ValueBoolean(value));
		}
	}
	...
	public static class MemberDateTime extends Member<Value<DateTime>, DateTime> {
		 ...
		 */
		public MemberDateTime(@Nonnull String name, @Nonnull Value<DateTime> value) {
		 ...
		 */
		public MemberDateTime(@Nonnull String name, @Nullable DateTime value) {
	...
	public static class MemberDouble extends Member<Value<Double>, Double> {
		 ...
		 */
		public MemberDouble(@Nonnull String name, @Nonnull Value<Double> value) {
		 ...
		 */
		public MemberDouble(@Nonnull String name, @Nullable Double value) {
		 ...
		 */
		public MemberDouble(@Nonnull String name, double value) {
			super(XMLRPCTypes.DOUBLE, name, new ValueDouble(value));
		}
		 ...
		 */
		public MemberDouble(@Nonnull String name, @Nullable Number value) {
			super(XMLRPCTypes.DOUBLE, name, new ValueDouble(value));
		}
		 ...
		 *             parsable number.
		 */
		public MemberDouble(@Nonnull String name, @Nonnull String value) {
	...
	public static class MemberInt extends Member<Value<Integer>, Integer> {
		 ...
		 */
		public MemberInt(@Nonnull String name, @Nonnull Value<Integer> value) {
		 ...
		 */
		public MemberInt(@Nonnull String name, @Nullable Integer value) {
		 ...
		 */
		public MemberInt(@Nonnull String name, int value) {
			super(XMLRPCTypes.INT, name, new ValueInt(value));
		}
		 ...
		 * @param value the {@link Number}.
		 */
		public MemberInt(@Nonnull String name, @Nullable Number value) {
			super(XMLRPCTypes.INT, name, new ValueInt(value));
		}
		 ...
		 *             parsable number.
		 */
		public MemberInt(@Nonnull String name, @Nonnull String value) {
	...
	public static class MemberString extends Member<Value<String>, String> {
		 ...
		 */
		public MemberString(@Nonnull String name, @Nonnull Value<String> value) {
		 ...
		 */
		public MemberString(@Nonnull String name, @Nullable String value) {
	...
	public static class MemberStruct extends Member<Value<Struct>, Struct> {
		 ...
		 */
		public MemberStruct(@Nonnull String name, @Nonnull Value<Struct> value) {
		 ...
		 */
		public MemberStruct(@Nonnull String name, @Nullable Struct value) {
	...
	public static class Value<T> {
		 ...
		 * @param value the member {@link Value}.
		 */
		public Value(@Nonnull XMLRPCTypes type, @Nullable T value) {
			this.type = type;
			this.value = value;
		}
		 ...
		 */
		@Nullable
		public static Value<?> read(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	...
	public static class ValueBase64 extends Value<Base64> {
		 ...
		 * @param value the {@link Base64}.
		 */
		public ValueBase64(@Nullable Base64 value) {
		 ...
		 */
		public ValueBase64(@Nullable String base64) {
		 ...
		 */
		public ValueBase64(@Nullable byte[] value) {
		 ...
		 */
		public ValueBase64(@Nullable byte[] value, boolean copy) {
	...
	public static class ValueBoolean extends Value<Boolean> {
		 ...
		 * @param value the {@link Boolean}.
		 */
		public ValueBoolean(@Nullable Boolean value) {
		...
		public ValueBoolean(int value) {
			super(XMLRPCTypes.BOOLEAN, ConversionUtil.parseBoolean(value, true));
		}
		 ...
		 */
		public ValueBoolean(@Nullable Object value) {
			super(XMLRPCTypes.BOOLEAN, ConversionUtil.parseBoolean(value));
		}
	}
	...
	public static class ValueDateTime extends Value<DateTime> {
		 ...
		 * @param value the {@link DateTime}.
		 */
		public ValueDateTime(@Nullable DateTime value) {
		 ...
		 */
		public ValueDateTime(@Nullable String iso8601) {
		 ...
		 */
		public ValueDateTime(@Nullable Calendar value) {
		 ...
		 */
		public ValueDateTime(@Nullable Date value) {
			super(XMLRPCTypes.DATETIME_ISO8601, new DateTime(value));
		}
	}
	...
	public static class ValueDouble extends Value<Double> {
		 ...
		 * @param value the {@link Double}.
		 */
		public ValueDouble(@Nullable Double value) {
		 ...
		 * @param value the {@link Number}.
		 */
		public ValueDouble(@Nullable Number value) {
	...
	public static class ValueInt extends Value<Integer> {
		 ...
		 * @param value the {@link Integer}.
		 */
		public ValueInt(@Nullable Integer value) {
		 ...
		 * @param value the {@link Number}.
		 */
		public ValueInt(@Nullable Number value) {
	...
	public static class ValueString extends Value<String> {
		 ...
		 * @param value the {@link String}.
		 */
		public ValueString(@Nullable String value) {
	...
	public static class ValueStruct extends Value<Struct> {
		 ...
		 * @param value the {@link String}.
		 */
		public ValueStruct(@Nullable Struct value) {
	...
	public static class Array extends ArrayList<Value<?>> {
		 ...
		 *             {@code null}.
		 */
		public Array(@Nonnull Collection<? extends Value<?>> collection) {
			super(collection);
		}
		 ...
		 */
		@Nonnull
		public static Array read(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	...
	public static class Base64 {
		 ...
		 */
		public Base64(@Nullable String base64String) {
		 ...
		 */
		public Base64(@Nullable byte[] bytes) {
			this(bytes, true);
		}
		...
		public Base64(@Nullable byte[] bytes, boolean copy) {
			if (bytes == null) {
				buffer = null;
			} else if (copy) {
		 ...
		 */
		@Nonnull
		public static Base64 read(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	...
	public static class DateTime {
		 ...
		 */
		public DateTime(@Nullable String iso8601String) {
		 ...
		 */
		public DateTime(@Nullable Calendar calendar) {
		 ...
		 */
		@Nonnull
		public static DateTime read(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
	...
	public static class Struct extends HashMap<String, Member<? extends Value<?>, ?>> {
		 ...
		 * specified {@link Map}. The {@link Struct} is created with default
		 * load factor (0.75) and an initial capacity sufficient to hold the
		 * mappings in the specified {@link Map}.
		 *
		 * @param map the map whose mappings are to be placed in this
		 *            {@link Struct}.
		 * @throws NullPointerException If the {@code map} is {@code null}.
		 */
		public Struct(@Nonnull Map<? extends String, ? extends Member<? extends Value<?>, ?>> map) {
			super(map);
		}
		 ...
		 */
		@Nullable
		public Member<? extends Value<?>, ?> put(@Nullable Member<? extends Value<?>, ?> member) {
		 ...
		 */
		@Nonnull
		public static Struct read(@Nonnull XMLStreamReader reader) throws XMLRPCException, XMLStreamException {
