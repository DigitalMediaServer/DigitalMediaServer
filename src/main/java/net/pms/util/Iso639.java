 ...
 */
public final class Iso639 { //TODO: (Nad) Refactor to enum? @Nullable
	 ...
	 * case the {@code ISO 639} code of the preferred language in the DMS
	 ...
	 * @param iso639_2 the {@code ISO 639-2} (three letter) code.
	 */
	 ...
	 * @param name the English language name.
	 * @param iso639_1 the {@code ISO 639-1} (two letter) code.
	 * @param iso639_2 the bibliographic {@code ISO 639-2} (three letter) code.
	 * @param altIso639_2 the terminology {@code ISO 639-2} (three letter) code.
	 */
	...
	public static class Iso639Entry {
		...
		/**
		 * @return The {@code ISO 639-1} (two letter) code.
		 */
		...
		/**
		 * @return The bibliographic {@code ISO 639-2} (three letter) code.
		 */
		 ...
		 *
		 * @param code the lower-case {@code ISO 639} (two or three letter)
		 *            code.
		 * @return {@code true} if a match is found, {@code false} otherwise.
		 */
