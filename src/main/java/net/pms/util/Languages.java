...
public final class Languages {
	 ...
	 */
	private static final String[] DMS_BCP47_CODES = {
		"af",      // Afrikaans
		"ar",      // Arabic
	...
	private static HashMap<String, TranslationStatistics> translationsStatistics = new HashMap<>(
		(int) Math.round(DMS_BCP47_CODES.length * 1.34)
	);
	...
	/**
	 * Returns a DMS supported {@link Locale} from the given <a
	...
	/**
	 * Returns a sorted string array of DMS supported language tags. The sorting
