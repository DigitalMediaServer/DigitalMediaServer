...
public class StandardPlayerId extends PlayerId {
	...
	/** The identifier for {@link FFmpegDVRMSRemux} */
	public static final PlayerId FFMPEG_DVRMS_REMUX = new StandardPlayerId("FFmpegDVRMSRemux");
	...
	static {
		...
		if (Platform.isWindows()) {
			allPlayers.add(FFMPEG_DVRMS_REMUX);
		}
