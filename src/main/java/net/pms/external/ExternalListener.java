...
/**
 * Base interface for DMS plugins. Classes implementing this interface and
 * packaged as DMS plugins will show up in the plugins section of the GUI.
 */
public interface ExternalListener {
	...
	/**
	 * Called when DMS is being closed. When this method returns, the plugin
