...
public class DLNAMediaSubtitle extends DLNAMediaLang implements Cloneable {
	 ...
	 *
	 * @return {@code true} if the subtitles are external file, {@code false}
	 *         otherwise.
	 */
	...
	/**
	 * Sets the {@link SubtitleType} for this instance.
	 *
	 * @param type the {@link SubtitleType} to set.
	 */
	public void setType(@Nonnull SubtitleType type) {
		if (type == null) {
	 ...
	 */
	public void setSubtitlesTrackTitleFromMetadata(@Nullable String value) {
	 ...
	 *             {@code null}.
	 */
	public void setExternalFile(@Nonnull File externalFile) throws FileNotFoundException {
		...
		if (externalFile != null && !type.isPicture()) {
			try {
				...
				if (match != null) {
					...
					if (lang == null || lang == ISO639.UND) {
						ISO639 tmpLanguage = ISO639.get(match.getLanguage());
						if (tmpLanguage != null) {
							lang = tmpLanguage;
						}
					}
	 ...
	 *
	 * @param charSet the subtitles character set name.
	 */
	public void setSubCharacterSet(@Nullable String charSet) {
		subsCharacterSet = charSet;
	}

	/**
	 * @return The subtitles character set name.
	 */
	@Nullable
	...
	/**
	 * @return {@code true} if the subtitles are {@code UTF-8} encoded,
	...
	/**
	 * @return {@code true} if the external subtitles file is {@code UTF-8}
	...
	/**
	 * @return {@code true} if the external subtitles file is {@code UTF-16}
	 *         encoded, {@code false} otherwise.
	 */
	...
	/**
	 * @return {@code true} if the external subtitles file is {@code UTF-32}
	 *         encoded, {@code false} otherwise.
	 */
	...
	/**
	 * @return {@code true} if the external subtitles file is {@code UTF-8},
	 *         {@code UTF-16} or {@code UTF-32} encoded, {@code false}
	 *         otherwise.
	 */
	 ...
	 */
	public void setConvertedFile(@Nullable File convertedFile) {
