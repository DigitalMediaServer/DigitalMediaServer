...
public class MapFile extends DLNAResource {
	 ...
	 */
	protected static boolean isFolderThumbnail(@Nullable File file, boolean evaluateExtension) {
		if (
	 ...
	 *         otherwise.
	 */
	protected static boolean isPotentialThumbnail(@Nullable File file) {
	 ...
	 *         otherwise.
	 */
	protected static boolean isPotentialThumbnail(@Nullable String fileName) {
