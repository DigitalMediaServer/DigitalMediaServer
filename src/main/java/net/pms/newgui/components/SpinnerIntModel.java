...
/**
 * An integer based spinner similar to {@link javax.swing.SpinnerNumberModel},
 * but with different minimum and maximum alignment in that minimum and maximum
 * don't have to be a multiple of step size.
 *
 * @author Nadahar
 */
public class SpinnerIntModel extends AbstractSpinnerModel implements Serializable, SpinnerModel  {
	...
	/**
	 * Constructs an integer based {@link SpinnerModel} where value is confined
	 * by {@code minimum} and {@code maximum}. Any change of value will be in
	 * {@code stepSize}.
	 *
	...
	/**
	 * Constructs an integer based {@link SpinnerModel} where value is confined
	 * by {@code minimum} and {@code maximum}. Any change of value will be of
	 * size 1.
	 *
	 * @param value the current integer value of the model.
	 * @param minimum the first integer in the range.
	...
	/**
	 * Constructs an integer based {@link SpinnerModel}. Any change of value
	 * will be in {@code stepSize}.
	 *
	 * @param value the current integer value of the model
	 * @param stepSize the difference between values
	 */
