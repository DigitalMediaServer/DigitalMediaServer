...
public class DefaultTextField extends JTextField implements FocusListener, ActionListener, KeyListener {
	...
	//TODO: (Nad) Javadocs (whole class)
	private static final long serialVersionUID = 1L;
	protected String defaultText;
	protected int defaultFontStyle = -1;
	protected final static Color STANDARD_DEFAULT_FONT_COLOR = UIManager.getColor("textInactiveText");
	...
	/**
	 * Constructs a new {@link DefaultTextField}. A default model is created,
	 * the initial string and the default text is {@code null}, and the number
	 * of columns is set to 0. {@code Enter} has standard behavior.
	 */
	 ...
	 * {@code null}, and the number of columns is set to 0. {@code Enter} has
	 * standard behavior.
	 *
	 ...
	 * Constructs a new {@link DefaultTextField} initialized with the specified
	 * default text. A default model is created, the initial string is
	 * {@code null}, and the number of columns is set to 0.
	 *
	 * @param defaultText The {@link String} that is to be displayed when the
	 *            text is blank.
	 ...
	 * string is set to {@code null}. {@code Enter} has standard behavior.
	 *
	...
	/**
	 * Sets the default text to show when the field is blank.
	 *
	...
	/**
	 * @return The {@link String} shown when the field is blank.
	 */
	...
	/**
	 * Get the font style integer applied to the default text. The integer value
	 * effect can be found from the {@link Font} constants. A negative value
	 * means that style override is disabled.
	 */
	 ...
	 * private by default) this empty method is needed to make the "Enter" key
