...
public class FilePermissionsTest {
	...
	public void testFilePermissions() throws URISyntaxException, IOException {
		...
		File file = new File(System.getProperty("java.io.tmpdir"), String.format("DMS_temp_writable_file_%d.tmp", new Random().nextInt(10000)));
		...
		Path path = Paths.get(System.getProperty("java.io.tmpdir"), String.format("DMS_temp_writable_file_%d.tmp", new Random().nextInt(10000)));
